...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Premium Indonesian Vanilla Beans for Export", description: "Direct sourcing, export-ready grades, vacuum packaging and worldwide delivery from Ask Global.", images: ["/hero-vanilla.png"] },
};
