    ...
    <form action={saveCompanySettingsAction} className="admin-form admin-editor-with-preview">
      <article className="admin-card">
        ...
        <div className="admin-form-grid">
          <label><span>Nama brand</span><input name="brand_name" defaultValue={settings.brand_name} required /><small>Nama pendek yang tampil di website.</small></label>
          ...
          <ImageUploadField name="logo_url" label="Logo perusahaan" defaultValue={settings.logo_url ?? ""} folder="brand" help="Gunakan PNG atau WebP transparan agar logo terlihat rapi pada header." />
